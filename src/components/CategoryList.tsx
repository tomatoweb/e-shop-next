        ...
        <div className="flex gap-4 md:gap-8">
            <Link href="/list?cat=test" className="flex-shrink-0 w-full sm:w-1/2 lg:w-1/4 xl:w-1/6">
                <div className="relative bg-slate-100 w-full h-96">
                    <Image alt="" src="https://images.pexels.com/photos/816495/pexels-photo-816495.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" fill sizes="20vw" className="object-cover"/>
                </div>
